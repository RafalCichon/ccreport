...
## Usage
`
ccreport --organization-url https://dev.azure.com/your_organization --project-name "Project Name" --token 24yu2y34gu23 --definition-regex "(^\\base_services\\|^\\custom_services\\)" --branch-name v1.2.0
`
